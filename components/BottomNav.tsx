...
type Tab = "home" | "house" | "meals" | "vault" | "reminders";
      ...
      {TABS.map((tab) => {
        ...
        return (
          <button
            ...
            style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4, minWidth: 56, background: "none", border: "none", cursor: "pointer", padding: 0 }}
          >
            <span
              style={{
                display: "flex",
